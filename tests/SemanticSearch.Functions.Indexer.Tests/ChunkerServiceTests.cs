...
public class ChunkerServiceTests
{
    ...
    {
        var text   = Words(600);
        var chunks = _chunker.SlidingWindow("doc-1", "a.txt", text, windowSize: 512, overlap: 64);
    ...
    {
        var chunks = _chunker.SlidingWindow(
            "doc-1", "a.txt", "hello world this is a short text", windowSize: 512, overlap: 64);
    ...
    {
        var chunks = _chunker.SlidingWindow("doc-1", "a.txt", string.Empty, windowSize: 512, overlap: 64);
    ...
    [Fact]
    public void SlidingWindow_PropagatesDocIdAndFilename()
    {
        var chunks = _chunker.SlidingWindow("doc-42", "contrato.pdf", "hello world", windowSize: 512, overlap: 64);

        chunks[0].DocId.Should().Be("doc-42");
        chunks[0].Filename.Should().Be("contrato.pdf");
    }
